...
# Should return 10
#
print('Adding 6 + 4 = ' + str(calculator(first_number=6, second_number=4, operation='add')))
...
#
print('Dividing 6 / 4 = ' + str(calculator(first_number=6, second_number=4, operation='subtract')))
